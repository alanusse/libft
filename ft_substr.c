...
/*   Updated: 2023/09/28 16:17:34 by aglanuss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	printf("test 2: %s\n", ft_substr("hola como estas", 0, 15)); // output: hola como estas
// 	printf("test 3: %s\n", ft_substr("hola como estas", 0, 20000)); // output: hola como estas
